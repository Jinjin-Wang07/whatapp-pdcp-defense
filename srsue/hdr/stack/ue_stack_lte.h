...
public:
  ...
  void set_last_cqi(srsran_cqi_type_t cqi_type, uint8_t cqi) { return pdcp.set_last_cqi(cqi_type, cqi); };
  void set_last_mcs(uint32_t mcs_idx) { return pdcp.set_last_mcs(mcs_idx); };
