...
class pdcp_interface_phy
{
public:
  /* report CQI, MCS to PDCP layer */
  virtual void set_last_cqi(uint16_t rnti, srsran_cqi_type_t cqi_type, uint8_t cqi) = 0;
  virtual void set_last_mcs(uint16_t rnti, uint32_t mcs_idx)                        = 0;
};
} // namespace srsenb
