...
public:
  pdcp_config_t(uint8_t              bearer_id_,
                ...
                uint32_t             concatenating_timer_ms_ = 5) :
    ...
    rat(rat_),
    concatenating_timer_ms(concatenating_timer_ms_)
  {
  ...
  uint32_t             concatenating_timer_ms = 5;  // PDCP concatenating timer in milliseconds
  ...
  bool operator==(const pdcp_config_t& other) const
  {
    return bearer_id == other.bearer_id and rb_type == other.rb_type and tx_direction == other.tx_direction and
           ...
           status_report_required == other.status_report_required and 
           concatenating_timer_ms == other.concatenating_timer_ms;
  }
