...
class pdcp : public srsue::pdcp_interface_rlc, public srsue::pdcp_interface_rrc, public srsue::pdcp_interface_phy
{
public:
  ...
  // PHY interface
  void set_last_cqi(srsran_cqi_type_t cqi_type, uint8_t cqi) override;
  void set_last_mcs(uint32_t mcs_idx) override;
...
private:
  ...
  srsran::pdcp_pcap* encrypted_pcap = nullptr;
  srsran::pdcp_pcap* plaintext_pcap = nullptr;
  srsran::gw_pcap*   gw_pcap        = nullptr;
