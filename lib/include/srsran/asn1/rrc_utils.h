 ...
 *      PDCP Config
 **************************/
// Global PDCP configuration that can be set from configuration files
struct pdcp_global_config_t {
  uint32_t concatenating_timer_ms = 5;  // Default 5ms
};

// Global PDCP configuration instance
extern pdcp_global_config_t g_pdcp_config;

// Function to set global PDCP configuration
void set_pdcp_global_config(uint32_t concatenating_timer_ms);
