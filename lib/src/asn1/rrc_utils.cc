...
srsran::pdcp_config_t make_srb_pdcp_config_t(const uint8_t bearer_id, bool is_ue)
{
  pdcp_config_t cfg(bearer_id,
                    ...
                    false,
                    srsran_rat_t::lte,
                    g_pdcp_config.concatenating_timer_ms);  // Use global configuration
  return cfg;
}
